...
class PhoneNumberValidator extends TextFieldValidator {
  PhoneNumberValidator({required String errorText}) : super(errorText);

  @override
  bool isValid(String? value) {
    // Define a regular expression pattern that matches a 13-digit phone number.
    final RegExp phoneNumberRegExp = RegExp(r'^\d{10}$');

    // Use the regular expression to check if the input matches the pattern.
